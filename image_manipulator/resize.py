...
def resize_image_from_path(image_path: str, size: Tuple[int, int]) -> Image.Image:
...
def crop_image(image: Image.Image, upper_left_corner_pos: Tuple[int, int], new_size: Tuple[int, int]) -> Image.Image:
